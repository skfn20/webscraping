...
if __name__ == '__main__':
    writeChannelInfo("https://www.youtube.com/channel/UC0CZYapctCIZxmC-FRUbrVA")
    writeChannelInfo("https://www.youtube.com/channel/UCkFGfvN6AAhoBVSqju0CgmA")
    writeChannelInfo("https://www.youtube.com/channel/UCRaEQm6yar7P7FeVpkL8xYg")
    writeChannelInfo("https://www.youtube.com/channel/UCwTg-6vuMNVKQYX-TgSiC8A")
    writeChannelInfo("https://www.youtube.com/channel/UCwdZgECLGRyHszZemaxgXJA")
    writeChannelInfo("https://www.youtube.com/channel/UC4E2H4oEIbwRRWvIcOJQtBg")
    writeChannelInfo("https://www.youtube.com/channel/UCn9mJ4htO64-1osMWYu9k5Q")
